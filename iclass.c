		...
		if ((receivedCmd[0] == ICLASS_CMD_CHECK) || (receivedCmd[0] == ICLASS_CMD_CHECK_KC)){ // 0x05 0x95
			...
			if (simulationMode == MODE_FULLSIM)  {
				...
				// 	check_count = 0;
					...
					response_delay = delay_for_check_res;//We need to hurry here...
					//exitLoop = true;
				// }
				// else{
			...
			// 					Dbprintf("diversified_key_c: %02x %02x %02x %02x %02x %02x %02x %02x"
			// 				   ,diversified_key_c[0],diversified_key_c[1],diversified_key_c[2],diversified_key_c[3]
			// 				   ,diversified_key_c[4],diversified_key_c[5],diversified_key_c[6],diversified_key_c[7]);
				
			// 	Dbprintf("diversified_key: %02x %02x %02x %02x %02x %02x %02x %02x"
			// 				   ,diversified_key[0],diversified_key[1],diversified_key[2],diversified_key[3]
			// 				   ,diversified_key[4],diversified_key[5],diversified_key[6],diversified_key[7]);
			// }			
